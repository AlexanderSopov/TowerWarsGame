import { WORLD_HEIGHT, WORLD_WIDTH, Tile } from "../tile-system";
import { TileState } from "./TroopMovement";

// Initialize the game world with empty tiles
export const emptyWorld = () => {
  const world: { state: TileState, unitIds: string[] | null | undefined }[][] = []
